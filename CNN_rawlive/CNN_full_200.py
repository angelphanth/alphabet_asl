...
plot_model(model, to_file='CNN_allasl_200.png', 
show_shapes=True, show_layer_names=True)

# Creating callbacks
# Model checkpointer that will only save the weights from the epoch with the best validation accuracy
checkpoint = ModelCheckpoint("best_weights_all200.h5", monitor='val_accuracy', verbose=1, save_best_only=True, mode='max')
...
with open("CNN_allasl_200_arch.json","w") as json_file:
...
bestmodel.load_weights("best_weights_all200.h5")
