...
pretrained = VGG19(weights='imagenet', include_top=False, pooling='max', input_shape=(pixels,pixels,channels))
...
plot_model(model, to_file='vgg19_trainable.png', 
...
checkpoint = ModelCheckpoint("best_weights_vgg19.h5", monitor='val_accuracy', verbose=1, save_best_only=True, mode='max')
...
with open("VGG19_all.json","w") as json_file:
...
bestmodel.load_weights("best_weights_vgg19.h5")
