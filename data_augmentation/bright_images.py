...
# Each image (64x64=4,096 array) will be saved as a row in dataframes (1. df for brightened grey images, 2. df for bright colour, 3. df for original images) which will be saved to .csv files. 
...
classes = np.genfromtxt(f'C:/Users/main/Desktop/alphabet_asl/asl_list/{sys.argv[1]}/{sys.argv[2]}', delimiter='\n', dtype='str')
...
# Writing to csv
to_add_grey.to_csv(f'C:/Users/main/Desktop/alphabet_asl/asl_list/{sys.argv[1]}/{sys.argv[3]}')
to_add_colour.to_csv(f'C:/Users/main/Desktop/alphabet_asl/asl_list/{sys.argv[1]}/{sys.argv[4]}')
to_add_original.to_csv(f'C:/Users/main/Desktop/alphabet_asl/asl_list/{sys.argv[1]}/{sys.argv[5]}')
...
for letter in classes:
    ...
    image_paths = glob.glob(f'C:/Users/main/Desktop/alphabet_asl/asl_alphabet_train/training_set/{letter}/*')
    ...
    for path in image_paths:
        ...
        path_removed = path.replace(f'C:/Users/main/Desktop/alphabet_asl/asl_alphabet_train/training_set/{letter}\\','')
    ...
    for image in image_names:
        ...
        grey_img = cv2.imread(f'C:/Users/main/Desktop/alphabet_asl/asl_alphabet_train/training_set/{letter}\\{image}.jpg', cv2.IMREAD_GRAYSCALE)
        # Read in the same image unchanged (in colour with 3 channels (RGB))
        colour_img = cv2.imread(f'C:/Users/main/Desktop/alphabet_asl/asl_alphabet_train/training_set/{letter}\\{image}.jpg', cv2.IMREAD_UNCHANGED)
        ...
        df_grey_images.to_csv(f'C:/Users/main/Desktop/alphabet_asl/asl_list/{sys.argv[1]}/{sys.argv[3]}', 
        mode='a', header=False)
        df_bright_images.to_csv(f'C:/Users/main/Desktop/alphabet_asl/asl_list/{sys.argv[1]}/{sys.argv[4]}', 
        mode='a', header=False)
        df_original_images.to_csv(f'C:/Users/main/Desktop/alphabet_asl/asl_list/{sys.argv[1]}/{sys.argv[5]}', 
        mode='a', header=False)

        # Saving the transformed images (must reverse normalization by multiplying each pixel by 255)
        bool_status = cv2.imwrite(f'C:/Users/main/Desktop/alphabet_asl/bright_grey/training_set/{letter}/grey_{image}.jpg', 255*bright_grey_img)
        # Sanity verbose
        print(f'"grey_{image}.jpg" has been saved: {bool_status}')

        colour_status = cv2.imwrite(f'C:/Users/main/Desktop/alphabet_asl/brighten_only/training_set/{letter}/bright_{image}.jpg', 255*bright_colour_img)
        # Sanity verbose 
